...
export default function NewsletterSection() {
  return (
    <section className='w-full bg-agro-orange-dark py-16 md:py-20'>
      <div className='mx-auto max-w-5xl px-4 sm:px-6 lg:px-8'>
        <div className='grid md:grid-cols-2 gap-10 md:gap-16 items-center'>
          <div>
            <span className='font-arial text-xs font-bold uppercase tracking-wider text-white'>
              Newsletter
            </span>
            ...
            <p className='font-arial text-base text-white leading-relaxed mt-4 max-w-md'>
